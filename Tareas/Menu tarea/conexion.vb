...
Public Class conexion
    ...
    Public conexion As SqlConnection = New SqlConnection("Data Source= DORISMEZA\SQLEXPRESS;Initial Catalog=Ejemplo; Integrated Security=True")
    ...
    Function buscarEstudiante(ByVal condicion) As DataTable
        Try
            ...
            'SQLcommand requiere dos parametros: 1. Instruccion sql que será 'buscar',
            'almacena la instrucción sql.
